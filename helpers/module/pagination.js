...
class Pagination extends Component {
  ...
  render() {
    ...
    console.log('check', pageNo, active);
    return (
      <div className="TB_paging">
        <a
          onClick={() => this.handlePage(1)}
          className={
            active === 1 || this.s_page === 1
              ? 'TB_paging_button disabled'
              : 'TB_paging_button'
          }
        >
          <img
            className="TB_paging_button_img"
        ...
        <div className="TB_paging_button_number">
          {pageNo.map(no => (
            <a
              key={no}
              href="javascript:;"
